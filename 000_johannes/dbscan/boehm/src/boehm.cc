...
static auto runDbscan (
  ...
  findClusters(
    d_pointStates, d_clusters, points.d_x, points.d_y, points.n, d_seedLists, d_seedClusterIds, d_seedLengths, d_syncCounter, collisionHandlingData, d_processedIdxs, coreThreshold, r * r
  );
